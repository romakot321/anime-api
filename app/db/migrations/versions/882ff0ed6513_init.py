...
Revision ID: 882ff0ed6513
Revises: 
Create Date: 2025-02-12 14:16:11.770667
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('image', 'video', name='tasktype'), nullable=False),
    ...
    sa.Column('task_id', sa.Uuid(), nullable=False),
    sa.Column('status', sa.Enum('queued', 'finished', 'error', name='taskstatus'), server_default='queued', nullable=False),
